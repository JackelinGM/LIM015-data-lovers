...
En este pagina web podras visualizar un
_conjunto (set) de datos_** que se adecue a la necesidad del usuario.

podras **visualizar la data,
...
Lograr que el usuario encuentre ,informacion para una batalla pokemon y asi logre la victoria.
